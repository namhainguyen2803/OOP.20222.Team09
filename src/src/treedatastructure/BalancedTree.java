...
public class BalancedTree extends GenericTree{
    ...
    @Override
    public Node insertNode(int parentId, int childId) throws NodeExistedException, NodeNotExistsException, NodeFullChildrenException {
        Node child = super.insertNode(parentId, childId);
